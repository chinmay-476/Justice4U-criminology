...
from routes.dev_docs_routes import register_dev_docs_routes
...
from routes.video_call_routes import register_video_call_routes
...
def register_all_routes(app):
    ...
    register_video_call_routes(app)
    register_dev_docs_routes(app)
